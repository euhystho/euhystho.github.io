...
image: "./images/rhythm-run.jpeg"
imageAlt: "GitHub Respository for Rhythm-Run"
icon: "./icons/run.png"
iconAlt: "Orange Sneaker"
tags:
  [
    "Flutter",
    "Dart",
...
Plus, the example that the package provides works nicely:
![Lady Gaga's Disease song playing on SpotifySDK Example app ](images/rhythm-run/spotifysdk.png)
...
import PictureCarousel from "src/components/ui/image_carousel.astro";
import DesignDiagram from "./images/rhythm-run/design_diagram.png";
import Flowchart from "./images/rhythm-run/flowchart.png";
import Whiteboard from "./images/rhythm-run/whiteboard_brainstorm.png";

<PictureCarousel
  images={[
    {
      src: DesignDiagram,
      alt: "RhythmRun design diagram showing app architecture",
    },
    { src: Flowchart, alt: "RhythmRun development flowchart" },
    { src: Whiteboard, alt: "RhythmRun development brainstorm" },
  ]}
/>
...
- _**But limited time for actual implementation...**_
...
**Swift Integration for Apple Music**: [Flutter packages for Apple Music](https://pub.dev/packages/music_kit/) weren't reliable since I could never change the PlayerState or PlayerQueue, as shown below:
![Apple Music](images/rhythm-run/applemusic.jpeg)
Now I have enough iOS experience to implement native Swift integration properly.
